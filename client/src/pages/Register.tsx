...
export default function Register() {
  ...
  return (
    <div className="min-h-[calc(100vh-60px)] flex items-center justify-center px-4 py-12">
      ...
      >
        <h1 className="text-2xl font-black mb-6 text-center">Criar Conta</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm text-white/60 mb-1">Nome de usuário</label>
            <input
              type="text"
              className="input"
              value={username}
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="bg-card px-4 text-white/40">ou</span>
          </div>
        </div>
